 ...
 * standalone mission.
 */
class PasswordCheckMenu : public State
{
  private:
  ...
  public:
	...
	PasswordCheckMenu(ServerInfo* serverinfo, std::string player, bool isUDP, bool isDirect);
	PasswordCheckMenu(std::string ipAddress, std::string player, uint16_t port, bool isUDP, bool isDirect);
