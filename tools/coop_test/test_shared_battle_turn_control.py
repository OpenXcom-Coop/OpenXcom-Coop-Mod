"""Bug: in a SHARED battle BOTH players said "your turn" and could command the SAME set of
...
Fix: in SHARED derive the role from the unambiguous server-owner flag (host machine = battle
...
Run:  python tools/coop_test/test_shared_battle_turn_control.py
"""
...
def main():
    js = shared_fixture.bring_up("jturn", (48888, 48889, 48188))
    ...
    try:
        ...
        print("ALL SHARED BATTLE-TURN-CONTROL TESTS PASSED")
    finally:
        js.shutdown()
